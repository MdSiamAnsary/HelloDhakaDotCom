...
public class HotelInfoDisplay extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet rs = stmt1.executeQuery("Select * from UH");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           ...
           Logger.getLogger(HotelInfoDisplay.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
